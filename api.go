...
func webDeletePost(w http.ResponseWriter, r *http.Request, _ httprouter.Params) {
	...
	// NOTE: An invalid subdomain should not happen.
	// The auth handler should reject POSTs with an invalid subdomain before this handler.
	// Reject any invalid subdomains anyway as a matter of caution.
	if !validSubdomain(a.Subdomain) {
